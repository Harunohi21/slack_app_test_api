...
ActiveRecord::Schema[7.1].define(version: 2024_07_09_063137) do
  ...
  create_table "m_users_profile_images", force: :cascade do |t|
    t.string "image_url"
    t.bigint "m_user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["m_user_id"], name: "index_m_users_profile_images_on_m_user_id"
  end
  ...
  create_table "t_direct_message_files", force: :cascade do |t|
    t.string "file"
    t.string "mime_type"
    t.string "extension"
    t.string "file_name"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["m_user_id"], name: "index_t_direct_message_files_on_m_user_id"
    t.index ["t_direct_message_id"], name: "index_t_direct_message_files_on_t_direct_message_id"
  end
  ...
  create_table "t_direct_messages", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
    t.boolean "draft_message_status"
  ...
  create_table "t_direct_react_msgs", force: :cascade do |t|
  ...
  create_table "t_direct_react_threads", force: :cascade do |t|
  ...
  create_table "t_direct_thread_msg_files", force: :cascade do |t|
    t.string "file"
    t.string "mime_type"
    t.string "extension"
    t.string "file_name"
    t.integer "direct_thread_id"
    t.bigint "t_direct_thread_id"
    t.bigint "m_user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["m_user_id"], name: "index_t_direct_thread_msg_files_on_m_user_id"
    t.index ["t_direct_thread_id"], name: "index_t_direct_thread_msg_files_on_t_direct_thread_id"
  end
  ...
  create_table "t_group_msg_files", force: :cascade do |t|
    t.string "file"
    t.string "mime_type"
    t.string "extension"
    t.string "file_name"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["m_user_id"], name: "index_t_group_msg_files_on_m_user_id"
    t.index ["t_group_message_id"], name: "index_t_group_msg_files_on_t_group_message_id"
  end

  create_table "t_group_react_msgs", force: :cascade do |t|
    t.integer "groupmsgid"
    t.integer "userid"
    t.string "emoji"
    t.datetime "created_at", null: false
  ...
  create_table "t_group_react_threads", force: :cascade do |t|
    t.integer "groupthreadid"
    t.integer "userid"
    t.string "emoji"
    t.datetime "created_at", null: false
  ...
  create_table "t_group_thread_msg_files", force: :cascade do |t|
    t.string "file"
    t.string "mime_type"
    t.string "extension"
    t.string "file_name"
    t.integer "groupthreadmsgid"
    t.bigint "t_group_thread_id"
    t.bigint "m_user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["m_user_id"], name: "index_t_group_thread_msg_files_on_m_user_id"
    t.index ["t_group_thread_id"], name: "index_t_group_thread_msg_files_on_t_group_thread_id"
  end
  ...
  create_table "t_user_channels", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
    t.string "unread_thread_message"
  ...
  add_foreign_key "m_users_profile_images", "m_users"
  add_foreign_key "t_direct_message_files", "m_users"
  add_foreign_key "t_direct_message_files", "t_direct_messages"
  add_foreign_key "t_direct_thread_msg_files", "m_users"
  add_foreign_key "t_direct_thread_msg_files", "t_direct_threads"
  ...
  add_foreign_key "t_group_msg_files", "m_users"
  add_foreign_key "t_group_msg_files", "t_group_messages"
  add_foreign_key "t_group_thread_msg_files", "m_users"
  add_foreign_key "t_group_thread_msg_files", "t_group_threads"
